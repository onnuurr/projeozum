...
use Modules\Marketplace\Services\MarketplaceSyncOrchestrator;
...
class TrendyolController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Marketplace::Portal/Marketplace/Trendyol/Dashboard', [
    ...
    public function pullOrders(Request $request): RedirectResponse
    {
        ...
        \Modules\Marketplace\Jobs\Trendyol\PullTrendyolOrdersJob::dispatch(
            $tenant->id,
    ...
    public function listings(Request $request): Response
    {
        ...
        return Inertia::render('Marketplace::Portal/Marketplace/Trendyol/Listings', [
            'tenant' => $this->payload($tenant),
            'sales'  => $sales,
        ]);
    }
